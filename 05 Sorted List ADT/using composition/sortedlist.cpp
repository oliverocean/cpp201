 ...
 * Ch. 12, #1 (p392)
 *
 * 1. Create list (sorted ADT)
 * 2. Insert 21 random numbers (1-100) using STL random library
 * 3. Display numbers as they are inserted
 * 4. Remove the first number inserted
 * 5. Display the sorted list of 20 numbers
 *
 * Default to automatic driver.
 * */
...
#include "SortedList_Has_A_SmartLinkedList.h"

// function prototypes
void theDriver(bool);
void sortedListDisplayer(const SortedListHasA<int>&);
...
void theDriver(bool autoDrive)
{
    ...
    SortedListHasA<int> sortedList;
    std::cout << "> Is the new list empty? [ " << std::boolalpha << sortedList.isListEmpty() << " ]\n";
    std::cout << "<< Sorted List of [ " << sortedList.getListSize() << " ] items created:\n";
    ...
    for (int i = 0; i < randomNumbers.size(); ++i)
    {
        ...
        sortedList.insert(randomNumbers[i]);
    }
    std::cout << "<< Sorted List of [ " << sortedList.getListSize() << " ] items:\n";
    sortedListDisplayer(sortedList);

    std::cout << "\n--[ STEP 4 ]--\n";
    std::cout << "-[ Remove the first number inserted ]-\n";
    std::cout << "<< Removing the first number that was inserted: [ " << randomNumbers[0] << " ]\n";
    sortedList.remove(randomNumbers[0]);
    ...
    SortedListHasA<int> sortedListCopy(sortedList);
    std::cout << "> Is the new list (copy) empty? [ " << std::boolalpha << sortedListCopy.isListEmpty() << " ]\n";
    std::cout << "<< Sorted List (copy) of [ " << sortedListCopy.getListSize() << " ] items:\n";
    sortedListDisplayer(sortedListCopy);

    std::cout << "\n> What is the 6th item? [ " << sortedListCopy.getItemAt(6) << " ]\n";
    std::cout << "<< Remove the 6th item...\n";
    sortedListCopy.removeItemAt(6);
    std::cout << "<< Sorted List of [ " << sortedListCopy.getListSize() << " ] items:\n";
    sortedListDisplayer(sortedListCopy);

    std::cout << "\n<< Insert the number 11...\n";
    sortedListCopy.insert(11);
    std::cout << "> What position is number 11? [ " << sortedListCopy.getPositionOf(11) << " ]\n";
    std::cout << "<< Sorted List of [ " << sortedListCopy.getListSize() << " ] items:\n";
    sortedListDisplayer(sortedListCopy);
    std::cout << "\n<< Remove the number 11...\n";
    sortedListCopy.remove(11);
    std::cout << "<< Sorted List of [ " << sortedListCopy.getListSize() << " ] items:\n";
    sortedListDisplayer(sortedListCopy);
    ...
    try
    {
        ...
        sortedListCopy.getPositionOf(-1);
    }
    ...
    try
    {
        ...
        sortedListCopy.getPositionOf(101);
    }
    catch (CustomException& e)
    {
        std::cout << e.what() << "\n";
    ...
    try
    {
        ...
        sortedListCopy.removeItemAt(22);
    }
    catch (CustomException& e)
    {
        std::cout << e.what() << "\n";
    ...
    std::cout << "\n<< Clear the list...\n";
    sortedListCopy.clearList();
    std::cout << "> Is the list empty? [ " << std::boolalpha << sortedListCopy.isListEmpty() << " ]\n";
    std::cout << "<< Sorted List of [ " << sortedListCopy.getListSize() << " ] items:\n";
    sortedListDisplayer(sortedListCopy);
...
void sortedListDisplayer(const SortedListHasA<int>& aSortedList)
{
    std::cout << " [ ";
    for (int s = 1; s <= aSortedList.getListSize(); ++s)
    {
        std::cout << aSortedList.getItemAt(s) << ", ";
    }
    std::cout << "]\n";
}
